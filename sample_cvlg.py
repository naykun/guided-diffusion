...
def do_run():
    ...
    gan_basedir = os.path.join(basedir,"gan")
    os.makedirs(gan_basedir, exist_ok=True)
    diffused_basedir = os.path.join(basedir,"diffused")
    os.makedirs(diffused_basedir, exist_ok=True)
